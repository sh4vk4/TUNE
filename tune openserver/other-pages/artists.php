...
<body>
    <div id="navigation-container">
        ...
        <ul>
            <li><a href="#" class="menu">ИСПОЛНИТЕЛИ</a></li>
    ...
    <div class="content">
        <div class="banner1 grid">
            <?php
                ...
                <h2>ИСПОЛНИТЕЛИ</h2>
                <th>ИМЯ</th>
                <th>ГОД ОСНОВАНИЯ</th>"; // start a table tag in the HTML
                    
                while($row = mysqli_fetch_array($query)){   //Creates a loop to loop through results
                echo "<tr><td>" . $row['artistName'] . "</td><td>" . $row['date'] ."</td></tr>";  //$row['index'] the index here is a field name
                }
