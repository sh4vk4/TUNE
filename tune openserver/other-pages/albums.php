...
<body>
    <div id="navigation-container">
        ...
        <ul>
            ...
            <li><a href="#" class="menu">АЛЬБОМЫ</a></li>
            <li><a href="tracks.php" class="menu">ТРЕКИ</a></li>
            <p id="menu">|</p>
    ...
    <div class="content">
        <div class="banner1">
            ...
            <?php
                ...
                $query = mysqli_query($link, "SELECT * FROM albums");
                ...
                <th>ИСПОЛНИТЕЛЬ</th>
                <th>ЖАНР</th>
                <th>ТРЕК</th>"; // start a table tag in the HTML
                    
                while($row = mysqli_fetch_array($query)){   //Creates a loop to loop through results
                echo "<tr><td>" . $row['albumName'] . "</td><td>" . $row['date'] . "</td><td>" . $row['artistName'] . "</td><td>" . $row['genre'] . "</td><td>" . $row['trackName'] ."</td></tr>";  //$row['index'] the index here is a field name
                }
